...
exports.array = exports.entry = exports.map = exports._isNode = exports.fromJS = exports.logic = exports.operatorMap = undefined;
...
function opFactory(iterable, opfn, other) {
    ...
    seq.has = function (key) {
        return iterable.has(key);
    };
    seq.get = function (key, notSetValue) {
...
function _isNodeSeq($a) {
    return (0, _xvnode._isNode)((0, _xvseq._first)($a));
}
...
_xvseq.Seq.prototype.op = function (operator, other) {
    ...
    if (typeof operator == "string") {
        ...
        var operatorName = operator in operatorMap ? operatorMap[operator] : operator;
...
_xvseq.Seq.prototype.data = function (asString) {
    ...
    if (!(0, _xvnode._isNode)($a)) {
        if ((0, _xvseq._isSeq)($a)) {
            return $a.map(function (_) {
                return (0, _xvnode._isNode)(_) ? dataImpl(_, asString) : _;
            });
        }
        return (0, _xvseq.seq)($a);
    }
...
function dataImpl(node) {
    ...
    var fltr = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
