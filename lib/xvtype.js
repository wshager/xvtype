...
exports.array = exports.entry = exports.map = exports._isNode = exports.fromJS = exports.attribute = exports.element = exports.logic = exports.operatorMap = undefined;
exports.item = item;
...
function string($a) {
    if ((0, _xvseq._isSeq)($a) || _isNode($a)) return data($a);
...
_xvseq.Seq.prototype.getTextNodes = function () {
    ...
    return this.filter(function (_) {
        if (!_isNode(_)) (0, _xverr.error)("err:XPTY0004", "Sequence cannot be converted into a node set.");
...
function instanceOf($a, $b) {
    let a = (0, _xvseq._first)($a);
    let b = (0, _xvseq._first)($b);
    if (!a) throw (0, _xverr.error)("XPTY0004");
